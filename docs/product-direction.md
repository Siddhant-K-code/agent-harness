...
5. **Public release decision:** choose the project license and public distribution policy; resolve notarization/signing and verify release checksums. Add Homebrew distribution after this path is stable. Broaden providers and infrastructure based on observed task requirements.
